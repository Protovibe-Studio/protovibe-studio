      ...
      <div className="flex items-center gap-2">
        <div className="relative flex items-center justify-center w-5 h-5 shrink-0">
          ...
          <div
            data-state={isChecked ? 'checked' : 'unchecked'}
            data-error={error}
            className="w-5 h-5 peer-focus-visible:ring-2 peer-focus-visible:ring-background-primary peer-focus-visible:ring-offset-2 data-[state=checked]:bg-background-primary data-[state=checked]:border-background-primary data-[error=true]:border-background-destructive flex items-center justify-center transition-colors bg-background-default border-2 border-border-strong rounded-sm"
          >
