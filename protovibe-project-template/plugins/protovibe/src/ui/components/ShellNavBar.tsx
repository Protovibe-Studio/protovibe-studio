...
import { Monitor, LayoutGrid, Palette, Paintbrush, Eye, EyeOff, PenTool, Sparkles, Share2, Loader2, ChevronRight, ChevronDown, CircleCheck, Pencil } from 'lucide-react';
...
function PublishButton() {
  ...
  const sectionHeader = (label: string, icon?: React.ReactNode) => (
    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '11px', fontWeight: 600, color: theme.text_tertiary, letterSpacing: '0.2px', marginBottom: '12px' }}>
      {icon}
      {label}
    </div>
  );
