...
export function TableRowContent({ className, children, ...props }: TableRowContentProps) {
  return (
    <tr
      className={cn("border-b border-border-default bg-background-default transition-colors hover:bg-background-primary-subtle-hover/30 last:border-b-0 even:bg-background-default", className)}
      {...props}
