...
export function Textarea({
  ...
  return (
    <div
      ...
      className={cn("border border-border-default text-sm cursor-text transition-colors data-[focused=true]:border-border-primary data-[disabled=true]:opacity-50 data-[disabled=true]:cursor-not-allowed data-[error=true]:border-background-destructive flex items-start gap-2 rounded flex-1 p-2 bg-background-sunken", className)}
