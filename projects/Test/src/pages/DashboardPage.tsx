  ...
  return (
    <div className="flex flex-col animate-in fade-in duration-300 gap-6 bg-background-default p-8 max-w-[1200px] mx-auto">
      {/* pv-editable-zone-start:d8z9a1 */}
        ...
        {/* pv-block-end:oryele */}
        {/* pv-block-start:w6xa3w */}
        <div data-pv-block="w6xa3w" className="flex flex-col gap-6">
          {/* pv-editable-zone-start:p9nj20 */}
          ...
          <div data-pv-block="25v9uy" className="flex flex-col gap-0.5">
            ...
            <div data-pv-block="0xc3jb" className="gap-0.5 border-border-default rounded">
              ...
              <TextParagraph className="max-w-[70ch]" data-pv-block="q1985x" typography="secondary">
                This project is an example prototype for you to start with. Below we've listed some less obvious things to know about Protovibe, in the form of a training playground.
              </TextParagraph>
              {/* pv-block-end:q1985x */}
              ...
              {/* pv-editable-zone-start:fl9kxd */}
                ...
                <div data-pv-block="6n8z5u" className="flex gap-3 flex-col grow">
                  ...
                  <div data-pv-block="7lddhq" className="flex flex-col gap-2">
                    ...
                    <TextParagraph className="text-foreground-primary text-sm" data-pv-block="oubpio" typography="regular">
                      Try double-clicking the menu button below. The menu will open and you can edit it normally.
                    </TextParagraph>
                    {/* pv-block-end:oubpio */}
                ...
                <Container data-pv-block="gftqjg">
                  {/* pv-editable-zone-start:mjedef */}
                    ...
                    <DropdownButton data-pv-block="l7yacs" label="Dropdown button" variant="solid" color="neutral" rightIcon="chevron-down">
                ...
                <div data-pv-block="aev719" className="grow flex flex-col gap-2">
                  ...
                  <div data-pv-block="8m03j8" className="flex flex-col gap-2">
                    ...
                    <TextParagraph data-pv-block="c7npsa" typography="small">
                      When working on the web you often need to traverse — select a parent element or a sibling. You can do it with keyboard shortcuts using the <b>WASD</b> keys, like playing a video game.
                    </TextParagraph>
                    {/* pv-block-end:c7npsa */}
                    {/* pv-block-start:quhudk */}
                    <TextParagraph className="text-foreground-primary text-sm" data-pv-block="quhudk" typography="regular">
                      Try selecting an avatar below, then press "W" to select its container.
                    </TextParagraph>
                    {/* pv-block-end:quhudk */}
                ...
                <div data-pv-block="fc34u6" className="flex gap-3 flex-col items-start grow">
                  ...
                  <div data-pv-block="v9egsq" className="flex flex-col gap-2">
                    ...
                    <TextParagraph data-pv-block="0zr6kw" typography="small">
                      Click the container below. Then, in the bottom floating toolbar, click "Add inside". It's faster if you use the Cmd+E shortcut. Try adding a button inside.
                    </TextParagraph>
                    {/* pv-block-end:0zr6kw */}
            
                    {/* pv-block-start:ljmhof */}
                    <TextParagraph className="text-foreground-primary text-sm" data-pv-block="ljmhof" typography="regular">
                      Try adding a button inside the container below.
                    </TextParagraph>
                    {/* pv-block-end:ljmhof */}
          ...
          {/* pv-block-end:pf1hzs */}
          {/* pv-editable-zone-end:p9nj20 */}
        </div>
        {/* pv-block-end:w6xa3w */}


        {/* pv-block-start:79snu8 */}
        <div data-pv-block="79snu8" className="flex flex-col gap-6">
          {/* pv-editable-zone-start:rvcay3 */}
          ...
          <div data-pv-block="oqzvp4" className="flex flex-col gap-0.5">
            ...
            <TextParagraph data-pv-block="3a7up9" typography="secondary">
              3 essential things to learn so you can make this app look like your brand.
            </TextParagraph>
            {/* pv-block-end:3a7up9 */}
                ...
                <div data-pv-block="ipmelx" className="flex gap-3 flex-col items-start grow">
                  ...
                  <div data-pv-block="yvndi1" className="flex flex-col gap-2">
                    ...
                    <TextParagraph data-pv-block="qh174e" typography="small">
                      In the top right, go to the "Tokens" tab and then into "Colors". From there you can change all the color variables to match your design system.
                    </TextParagraph>
                    {/* pv-block-end:qh174e */}
                    {/* pv-block-start:yspkyp */}
                    <TextParagraph className="text-foreground-primary text-sm" data-pv-block="yspkyp" typography="regular">
                      Go to the Tokens tab and try editing the background-primary colors. You'll see how the button colors change.
                    </TextParagraph>
                    {/* pv-block-end:yspkyp */}
              ...
              {/* pv-editable-zone-start:lz0sp5 */}
                ...
                <div data-pv-block="6qtzsl" className="flex gap-3 flex-col grow">
                  ...
                  <div data-pv-block="ssde0q" className="flex flex-col gap-2">
                    ...
                    <TextParagraph data-pv-block="ilrduc" typography="small">
                      Click the button below and look at the sidebar on the right. You'll see the component properties panel, where you can change variants and edit text.
                    </TextParagraph>
                    {/* pv-block-end:ilrduc */}
                    {/* pv-block-start:h4rc95 */}
                    <TextParagraph className="text-foreground-primary text-sm" data-pv-block="h4rc95" typography="regular">
                      Try changing this button to the outline variant.
                    </TextParagraph>
                    {/* pv-block-end:h4rc95 */}
                ...
                <Container data-pv-block="lzyvbi">
                  {/* pv-editable-zone-start:9slk3n */}
                    ...
                    <Button  data-pv-block="74gnna" label="Change me to Outline variant" variant="solid" color="primary" size="md" />
                    {/* pv-block-end:74gnna */}
                ...
                <div data-pv-block="smip6x" className="flex gap-3 flex-col grow">
                  ...
                  <div data-pv-block="kbxljz" className="flex flex-col gap-2">
                    ...
                    <TextParagraph data-pv-block="dpyqm3" typography="small">
                      We've built a starting point for you with all the buttons, form controls, tabs, etc. See what's there in the Components tab.
                    </TextParagraph>
                    {/* pv-block-end:dpyqm3 */}
              ...
              {/* pv-editable-zone-start:uvph0a */}
                ...
                <div data-pv-block="lh1j2e" className="flex gap-3 flex-col items-start grow">
                  ...
                  <div data-pv-block="99urzh" className="flex flex-col gap-1">
                    ...
                    <TextParagraph data-pv-block="9zziqs" typography="small">
                      Click the button below. Look at the right sidebar — you'll see a "Source files" section with 2 cards. Click the "Component" card to jump straight to the list of all variants of this component. <br />
                    </TextParagraph>
                    {/* pv-block-end:9zziqs */}
                    {/* pv-block-start:yhjj76 */}
                    <TextParagraph className="text-foreground-primary text-sm" data-pv-block="yhjj76" typography="regular">
                      Try changing the horizontal padding for all the buttons in the design system.
                    </TextParagraph>
                    {/* pv-block-end:yhjj76 */}
                ...
                <Container data-pv-block="boo3oh">
                  {/* pv-editable-zone-start:jyzz7z */}
                    ...
                    <Button leftIcon="mdi:view-grid-outline" data-pv-block="ftnyv4" label="I'm a component!" variant="outline" color="primary" size="md" />
                    {/* pv-block-end:ftnyv4 */}
                ...
                <div data-pv-block="fmtq4x" className="flex gap-3 flex-col items-start grow">
                  ...
                  <div data-pv-block="r7xusa" className="flex flex-col gap-1">
                    ...
                    <TextParagraph data-pv-block="1bnop2" typography="small">
                      You need to use the "Which state to style?" field. If you leave it empty, you'll style all variants of the component. If you only want to change the padding for a medium button, first select that you want to style "size: md".
                    </TextParagraph>
                    {/* pv-block-end:1bnop2 */}
                    {/* pv-block-start:elfure */}
                    <TextParagraph className="text-foreground-primary text-sm" data-pv-block="elfure" typography="regular">
                      Go to the Components tab and try changing the horizontal padding only for small buttons.
                    </TextParagraph>
                    {/* pv-block-end:elfure */}
                ...
                <div data-pv-block="p4z3qw" className="flex gap-3 flex-col items-start grow">
                  ...
                  <div data-pv-block="azunvx" className="flex flex-col gap-1">
                    ...
                    <TextParagraph data-pv-block="88ajzk" typography="small">
                      If something is hard to do, just ask your coding agent. You don't need to edit your app manually — but you can always tweak things like padding afterwards if you want.
                    </TextParagraph>
                    {/* pv-block-end:88ajzk */}
                    {/* pv-block-start:99amab */}
                    <TextParagraph className="text-foreground-primary text-sm" data-pv-block="99amab" typography="regular">
                      You can read the full docs at <br />protovibe-studio.github.io/docs
                    </TextParagraph>
                    {/* pv-block-end:99amab */}
