      ...
      <div className="pl-5">
        {/* pv-editable-zone-start:kcyc8f */}
          ...
          {/* pv-block-end:829q3t */}
              ...
              {/* pv-block-start:5ajv4c */}
              <Badge data-pv-block="5ajv4c" label="Badge" color="primary" />
              {/* pv-block-end:5ajv4c */}
        ...
        {/* pv-block-start:f6f0xf */}
          ...
          {/* pv-block-start:rqqqwa */}
          <Avatar outline data-pv-block="rqqqwa" initials="AB" size="md" bgColor="default" imageSrc="https://i.pravatar.cc/60" />
          {/* pv-block-end:rqqqwa */}
